...
- (id)init
{
    if (self = [self initWithFrame:CGRectMake(0, 0, 320, 30)])
    {
...
- (id)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        _carousel.backgroundColor = [UIColor grayColor];
...
- (UIView *)carousel:(iCarousel *)carousel viewForItemAtIndex:(NSUInteger)index reusingView:(UIView *)view
{
    if (!view)
    {
        ...
        UILabel *label = [[UILabel alloc] initWithFrame:CGRectMake(-10, 0, 120, 44)];
